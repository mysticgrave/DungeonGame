...
namespace PsychoticLab
{
    ...
    public class CharacterRandomizer : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // Mesh structure may not match (e.g. Synty instead of Polygon Fantasy). Skip setup.
            if (male.headAllElements == null || male.headAllElements.Count == 0)
            {
                enabled = false;
                return;
            }
        ...
        void BuildList(List<GameObject> targetList, string characterPart)
        {
            ...
            // Mesh structure may not match (e.g. different character pack). Skip if not found.
            if (targetRoot == null)
                return;
